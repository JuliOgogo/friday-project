...
import { packReducer, PacksActionType } from '../features/cards-packs/packs/pack-reducer'
...
export type RootActionsType = AuthActionsType | AppActionsType | PacksActionType
